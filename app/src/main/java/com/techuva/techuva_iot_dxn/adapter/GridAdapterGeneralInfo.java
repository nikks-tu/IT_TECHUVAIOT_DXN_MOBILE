...
import com.techuva.techuva_iot_dxn.utils.views.TextViewIcomoon;

import java.util.ArrayList;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class GridAdapterGeneralInfo extends ArrayAdapter<ProcomChannelDataResultObject> {
    private final int resource;
    private Context mContext;
    ArrayList<ProcomChannelDataResultObject> list;

    public GridAdapterGeneralInfo(@NonNull Context context, int resource, @NonNull ArrayList<ProcomChannelDataResultObject> objects) {
