...
import com.techuva.techuva_iot_dxn.utils.BubbleDrawableWhite;
...
public class GridAdapterWaterLevel extends ArrayAdapter<CurrentDataValueObject> {
    private final int resource;
    private Context mContext;
    ArrayList<CurrentDataValueObject> list;

    public GridAdapterWaterLevel(@NonNull Context context, int resource, @NonNull ArrayList<CurrentDataValueObject> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
            holder.progressBar_water_level.setMax(Integer.parseInt(item.getChannelDefaultValue()));
        }
