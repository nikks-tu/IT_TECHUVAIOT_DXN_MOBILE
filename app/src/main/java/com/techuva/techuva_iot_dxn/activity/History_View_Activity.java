...
import com.techuva.techuva_iot_dxn.adapter.ChannelDataAdapter;
import com.techuva.techuva_iot_dxn.adapter.ChannelNamesRcvAdapter;
...
public class History_View_Activity extends AppCompatActivity {
    ...
    private void showDate(int year, final int month, int day) {
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, R.style.DialogTheme1, new DatePickerDialog.OnDateSetListener() {
