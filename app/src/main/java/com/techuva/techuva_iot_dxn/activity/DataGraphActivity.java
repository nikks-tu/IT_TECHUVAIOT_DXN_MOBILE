...
import com.techuva.techuva_iot_dxn.adapter.HexagonChannelRcvAdapter;
import com.techuva.techuva_iot_dxn.api_interface.GetDataForGraph;
import com.techuva.techuva_iot_dxn.api_interface.HistoryDataInterface;
import com.techuva.techuva_iot_dxn.app.Constants;
import com.techuva.techuva_iot_dxn.listener.RecyclerItemClickListener;
...
import com.techuva.techuva_iot_dxn.model.HistoryDataInfoObject;
...
import com.techuva.techuva_iot_dxn.model.HistoryDataResultObject;
import com.techuva.techuva_iot_dxn.model.HistoryDataValueObject;
import com.techuva.techuva_iot_dxn.model.HistoryViewPaginationObject;
import com.techuva.techuva_iot_dxn.utils.views.AppDatabase;
import com.techuva.techuva_iot_dxn.utils.views.ChartHelper;
...
public class DataGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   rangebar_final.setOnRangeBarChangeListener((rangeBar, leftPinIndex, rightPinIndex, leftPinValue, rightPinValue) -> {
            ...
            minXRange = Float.parseFloat(minTime);
            if (rightPinValue.equals("24")) {
                maxTime = "23";
                maxXRange = Float.parseFloat("24");
            } else {
                maxTime = rightPinValue;
                maxXRange = Float.parseFloat(maxTime);
            }
            if (minTime.length() <= 1) {
            ...
            { sb1.append(maxTime);
                ...
                sb1.append("00");
                toTime = sb1.toString();}
            //Toast.makeText(context, ""+minTime+" " + maxTime , Toast.LENGTH_SHORT).show();
            pageNumber = 1;
            //valuelist.clear();
            //listforValues.clear();
            yValues.clear();
            ...
            chart_dailyData.moveViewToX(24);
            chart_dailyData.clear();
            chart_dailyData.invalidate();
            showLoaderNew();
            serviceCallforChannelData();
