...
import com.techuva.techuva_iot_dxn.adapter.GridAdapterDashboard;
import com.techuva.techuva_iot_dxn.api_interface.CurrentDataInterface;
import com.techuva.techuva_iot_dxn.api_interface.DeviceTokenDataInterface;
import com.techuva.techuva_iot_dxn.api_interface.GetConsumedUnits;
import com.techuva.techuva_iot_dxn.app.Constants;
import com.techuva.techuva_iot_dxn.model.ChannelUnitMeasureDO;
...
import com.techuva.techuva_iot_dxn.model.CurrentDataResultObject;
import com.techuva.techuva_iot_dxn.model.CurrentDataValueObject;
...
import com.techuva.techuva_iot_dxn.utils.views.AppDatabase;
import com.techuva.techuva_iot_dxn.utils.views.MApplication;
import com.techuva.techuva_iot_dxn.utils.views.MPreferences;
import com.techuva.techuva_iot_dxn.utils.views.MyFirebaseMessagingService;
...
public class Dashboard_Energy extends BaseActivity implements MyFirebaseMessagingService.EventListener {
    ...
    private void Init_Views() {
        context = Dashboard_Energy.this;
        mPreferences = new MPreferences(context);
        llContent.addView(inflater.inflate(R.layout.energy_dashboard_v_one, null), new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    public void goto_home() {
        ...
        {
            intent = new Intent(context, Dashboard_Energy.class);
            startActivity(intent);
        }
    ...
    private void generateDataList(List<CurrentDataValueObject> values)
    {
        ...
        if(arrayList.size()>0)
        {
            gridAdapterDashboard = new GridAdapterDashboard(Dashboard_Energy.this, R.layout.grid_item_dashboard, arrayList);
            grid_bottom.setAdapter(gridAdapterDashboard);
        }
    }

    public void showLoaderNew() {
        runOnUiThread(new Dashboard_Energy.Runloader(getResources().getString(R.string.loading)));
    }
